...
<section class="progreso d-flex justify-content-between align-items-center">
  ...
  <h2>📚 Libros leyéndose actualmente</h2>
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function actualizarFlechas() {
      // Forzamos un pequeño retraso para que el ancho total esté calculado
      setTimeout(() => {
      ...
      }, 100); // 100ms para asegurar que ya están renderizadas todas las tarjetas
    }
